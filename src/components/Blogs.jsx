            ...
            <div className="section-container">
                ...
                <div className="cards-grid">
                    <a href="https://medium.com/@kartikvegad1806/design-principles-edition-i-fce1cc59d5f1" className="card-link" target="_blank" rel="noopener noreferrer">
                        <div className="card">
                            <div className="card-image">
                                <img src="/images/blog1.png" alt="Design Principles" />
                            </div>
                    ...
                    <a href="https://medium.com/@kartikvegad1806/brutalism-the-beauty-of-raw-design-fcca8e70b58e" className="card-link" target="_blank" rel="noopener noreferrer">
                        <div className="card">
                            <div className="card-image">
                                <img src="/images/blog2.png" alt="Brutalism: The Beauty of Raw Design" />
                            </div>
                    ...
                    <div className="card">
                        <div className="card-image">
                            <img src="/images/examplary.png" alt="UI/UX Insights" />
                        </div>
                    ...
                    <div className="card">
                        <div className="card-image">
                            <img src="/images/examplary.png" alt="Another Blog" />
                        </div>
