        ...
        <section id="case-studies" className="section">
            <div className="section-container">
                ...
                <div className="cards-grid">
                    ...
                    <div className="card">
                        <div className="card-image">
                            <img src={`${import.meta.env.BASE_URL}images/examplary.png`} alt="E-learning Platform" />
                        </div>
                    ...
                    <div className="card">
                        <div className="card-image">
                            <img src={`${import.meta.env.BASE_URL}images/examplary.png`} alt="Fintech Mobile App" />
                        </div>
                    ...
                    <div className="card">
                        <div className="card-image">
                            <img src={`${import.meta.env.BASE_URL}images/examplary.png`} alt="Another Case Study" />
                        </div>
